...
auto UKF::InitializeStateVector(MeasurementPackage meas_package) -> VectorXd {
...
auto UKF::InitializeCovariance() -> MatrixXd {
...
void UKF::ProcessMeasurement(MeasurementPackage meas_package) {
  ...
  if (!is_initialized_) {
    ...
    x_ = InitializeStateVector(meas_package);
   ...
   *  P_aug.llt().matrixL(); This can fail when the the matrix is not 
   *  positive-definite which can happen with certain parameters.
   *  Ref: github 
   ****************************************************************************/
...
void UKF::PredictLidarMeasurement(const MatrixXd &Xsig_pred, MatrixXd &Zsig, 
...
void UKF::PredictRadarMeasurement(const MatrixXd &Xsig_pred, MatrixXd &Zsig, 
                                  VectorXd &z_pred, MatrixXd &S) {
